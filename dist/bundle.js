...
var contenttypes_1 = __webpack_require__(10);
var fields_1 = __webpack_require__(22);
var forms_1 = __webpack_require__(40);
var subscriptions_1 = __webpack_require__(44);
var queryable_1 = __webpack_require__(0);
var queryablesecurable_1 = __webpack_require__(11);
var util_1 = __webpack_require__(1);
var usercustomactions_1 = __webpack_require__(14);
var odata_1 = __webpack_require__(3);
var exceptions_1 = __webpack_require__(2);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var roles_1 = __webpack_require__(12);
var queryable_1 = __webpack_require__(0);
...
Object.defineProperty(exports, "__esModule", { value: true });
var queryable_1 = __webpack_require__(0);
var sitegroups_1 = __webpack_require__(13);
var util_1 = __webpack_require__(1);
/**
...
var sitegroups_1 = __webpack_require__(13);
var contenttypes_1 = __webpack_require__(10);
var folders_1 = __webpack_require__(23);
var roles_1 = __webpack_require__(12);
...
Object.defineProperty(exports, "__esModule", { value: true });
var queryable_1 = __webpack_require__(0);
var webs_1 = __webpack_require__(15);
var usercustomactions_1 = __webpack_require__(14);
var odata_1 = __webpack_require__(3);
var features_1 = __webpack_require__(21);
/**
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(17), __webpack_require__(51)(module)))
...
var logging_1 = __webpack_require__(5);
var rest_1 = __webpack_require__(43);
var pnplibconfig_1 = __webpack_require__(4);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var cachingConfigurationProvider_1 = __webpack_require__(18);
...
var searchsuggest_1 = __webpack_require__(27);
...
Object.defineProperty(exports, "__esModule", { value: true });
var caching_1 = __webpack_require__(20);
var httpclient_1 = __webpack_require__(9);
var logging_1 = __webpack_require__(5);
var util_1 = __webpack_require__(1);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var queryable_1 = __webpack_require__(0);
var FileUtil = __webpack_require__(50);
var odata_1 = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js__ = __webpack_require__(32);
...
/* harmony export (immutable) */ __webpack_exports__["initPnP"] = initPnP;
/* harmony export (immutable) */ __webpack_exports__["copyTaxonomyFieldValues"] = copyTaxonomyFieldValues;
...
function initPnP() {
    __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js__["setup"]({
        headers: {
            Accept: 'application/json; odata=verbose'
        }
    });
...
function copyTaxonomyFieldValues(sourceItemID, destItemID) {
    loadTaxonomyHiddenFields().then(() => getItemById(LIST_TITLE, sourceItemID).select(MM_FieldInternalName, MM_MULTI_FieldInternalName).get()).then(sourceItem => {
        ...
        const strMMMultiValue = mm_multi_Value ? __WEBPACK_IMPORTED_MODULE_1_lodash__["map"](mm_multi_Value.results, f => '-1;#' + f.Label + '|' + f.TermGuid).join(';') : null;
        resultValue[mm_multi_hidden_field] = strMMMultiValue;

        console.log(resultValue);

        return resultValue;
    }).then(r => getItemById(LIST_TITLE, destItemID).update(r)).then(() => console.log("OK")).catch(err => console.log(err));
}

function loadTaxonomyHiddenFields() {
    return __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js__["sp"].web.lists.getByTitle(LIST_TITLE).fields.select('Title', 'InternalName').get().then(fields => {
        mm_hidden_field = __WEBPACK_IMPORTED_MODULE_1_lodash__["find"](fields, {
            Title: MM_FieldInternalName + '_0'
        }).InternalName;

        mm_multi_hidden_field = __WEBPACK_IMPORTED_MODULE_1_lodash__["find"](fields, {
...
function getItemById(listTitle, id) {
    return __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js__["sp"].web.lists.getByTitle(listTitle).items.getById(id);
}
